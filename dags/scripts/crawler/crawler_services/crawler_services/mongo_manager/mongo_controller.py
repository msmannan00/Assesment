...
from scripts.crawler.crawler_services.crawler_services.mongo_manager.mongo_enums import MONGO_CRUD, MONGODB_KEYS, MONGO_CONNECTIONS, MONGODB_PROPERTIES
from scripts.crawler.crawler_services.crawler_services.mongo_manager.mongo_request_generator import mongo_request_generator
...
class mongo_controller(request_handler):
    ...
    def __reset(self, p_data):
        try:
            ...
            return True, MANAGE_DATABASE_MESSAGES.S_UPDATE_SUCCESS

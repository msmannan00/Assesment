...
from scripts.crawler.crawler_instance.genbot_service.auto_pipe_node_manager.load_static_manager.load_static_url_enums import STATIC_URL_RULES, STATIC_URL_DATA_RULES

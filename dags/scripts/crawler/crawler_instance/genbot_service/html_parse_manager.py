...
from scripts.crawler.crawler_instance.genbot_service.genbot_enums import PARSE_TAGS
from scripts.crawler.crawler_instance.local_shared_model.article_model import article_model
...
from scripts.crawler.crawler_services.helper_services.spell_check_handler import spell_checker_handler
import nltk
...
class html_parse_manager(HTMLParser, ABC):
    ...
    def __generate_article_analytics(self, p_validity_score, p_content_type, p_video, p_images):
        URL = "http://192.168.10.5:8000/fakenews/"
        ...
        self.m_article_model.m_content_time = str(time.time())

...
from scripts.crawler.constants.constant import TOR_CONSTANTS, CRAWL_SETTINGS_CONSTANTS, TOR_CONNECTION_CONSTANTS
from scripts.crawler.constants.keys import TOR_KEYS
from scripts.crawler.constants.strings import TOR_STRINGS, STRINGS
from scripts.crawler.crawler_instance.tor_controller.tor_enums import TOR_COMMANDS, TOR_CMD_COMMANDS, TOR_STATUS
...
class tor_controller(request_handler):
    ...
    def __on_start_subprocess(self):
        ...
        if not APP_STATUS.DOCKERIZED_RUN:
            ...
            self.__m_controller = Controller(stem.socket.ControlPort("10.0.0.102", 9053))

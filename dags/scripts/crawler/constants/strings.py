from scripts.crawler.constants.constant import TOR_CONNECTION_CONSTANTS
...
class TOR_STRINGS:
    S_SOCKS_HTTP_PROXY = "socks5h://10.0.0.102:"
    S_SOCKS_HTTPS_PROXY = "socks5h://10.0.0.102:"
...
class MANAGE_DATABASE_MESSAGES:
